                ...
                if (imageStream != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(imageUrl))
                    {
                        ...
                        if (AIResult != null)
                        {
                            ...
                            await DeviceController.SendDeviceToCloudMessageAsync(resultMessage);
                            // System.Identify dosyası 4.0.3.308261200 => Bot.Builder 3.5.5 => Azure.Devices.Client 1.1.2
                            // olmak zorunda yoksa kütüphaneler birbirine giriyor.
                        }
                        else
                        {
